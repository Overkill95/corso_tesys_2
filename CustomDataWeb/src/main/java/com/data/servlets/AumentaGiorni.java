...
@WebServlet("/aumentagiorni")
public class AumentaGiorni extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (rootNode.has("giorni")) {
                ...
                oldData.aumentaGiorniDi(giorni);
            }
            ...
            response.getWriter().write("Errore durante l'elaborazione della richiesta");
        }
    }
...
//        
//        int giorniDaAumentare = Integer.parseInt(giorniStringa);
//        
//        data1.aumentaGiorniDi(giorniDaAumentare);
//        
//        ObjectMapper objectMapper = new ObjectMapper();
